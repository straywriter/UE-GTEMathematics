...
namespace gte
{
    ...
    public:
        ...
        bool FitUsingSquaredLengths(int32_t numPoints, Vector3<Real> const* points, Sphere3<Real>& sphere)
        {
        ...
        // set to 'true'.
        uint32_t FitUsingLengths(int32_t numPoints, Vector3<Real> const* points,
