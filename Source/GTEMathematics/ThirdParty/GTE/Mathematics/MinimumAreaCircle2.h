...
namespace gte
{
    ...
    public:
        ...
        bool operator()(int32_t numPoints, Vector2<InputType> const* points, Circle2<InputType>& minimal)
        {
            if (numPoints >= 1 && points)
            {
                // Function array to avoid switch statement in the main loop.
                std::function<UpdateResult(int32_t)> update[4];
        ...
        inline std::array<int32_t, 3> const& GetSupport() const
        {
            return mSupport;
        }
    ...
    private:
        ...
        // squared radius.
        bool Contains(int32_t i, Circle2<ComputeType> const& circle) const
        {
        ...
        Circle2<ComputeType> ExactCircle1(int32_t i0) const
        {
        ...
        Circle2<ComputeType> ExactCircle2(int32_t i0, int32_t i1) const
        {
        ...
        Circle2<ComputeType> ExactCircle3(int32_t i0, int32_t i1, int32_t i2) const
        {
        ...
        UpdateResult UpdateSupport2(int32_t i)
        {
            ...
            int32_t iCircle = 0, iMinRSqr = -1;
            int32_t k0, k1;

            // Permutations of type 2.
            for (int32_t j = 0; j < numType2; ++j, ++iCircle)
            {
        ...
        UpdateResult UpdateSupport3(int32_t i)
        {
            ...
            // Permutations of type 3.
            for (int32_t j = 0; j < numType3; ++j, ++iCircle)
            {
